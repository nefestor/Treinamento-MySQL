CREATE DATABASE BancoNovo;
    ...
    EXEC ('CREATE SCHEMA Courses');
        ...
        ALTER TABLE Courses.Tutors ADD CONSTRAINT fk_id_course
			FOREIGN KEY(id_course) REFERENCES Persons.Courses.Tutors(id_course);
    ...
    EXEC ('CREATE SCHEMA Classes');
        ...
        ALTER TABLE Classes.Courses_Classes_Tutors ADD CONSTRAINT fk_id_course_class
			FOREIGN KEY(id_course_class) REFERENCES Classes.Courses_Classes(id_course_class);
        ALTER TABLE Classes.Courses_Classes_Tutors ADD CONSTRAINT fk_id_course_tutor
        ...
        ALTER TABLE Classes.Courses_Classes_Schedule ADD CONSTRAINT fk_id_course_class
			FOREIGN KEY(id_course_class) REFERENCES Classes.Courses_Classes(id_course_class);

        -- Foreign Key Classes.Courses_Classes_Contents

        ALTER TABLE Classes.Courses_Classes_Contents ADD CONSTRAINT fk_id_course_class
			FOREIGN KEY(id_course_class) REFERENCES Classes.Courses_Classes(id_course_class);
    ...
    EXEC ('CREATE SCHEMA Contents');
        ...
        ALTER TABLE Contents.Courses_Classes_Activities ADD CONSTRAINT fk_id_course_classe
			FOREIGN KEY (id_course_classe) REFERENCES Classes.Courses_Classes(id_course_classe);

        -- Foreign Key Contents.Courses_Classes_Assessements

        ALTER TABLE Contents.Courses_Classes_Assessements ADD CONSTRAINT fk_id_course_classe
			FOREIGN KEY (id_course_classe) REFERENCES Classes.Courses_Classes(id_course_classe);
